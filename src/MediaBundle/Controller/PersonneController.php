...
class PersonneController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MediaBundle\Form\PersonneType', $personne);
        ...
        return $this->render('MediaBundle:admin:personne/new.html.twig', array(
            'personne' => $personne,
    ...
    public function showAction(Personne $personne)
    {
        ...
        return $this->render('MediaBundle:admin:personne/show.html.twig', array(
            'personne' => $personne,
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('MediaBundle\Form\PersonneType', $personne);
        ...
        return $this->render('MediaBundle:admin:personne/edit.html.twig', array(
            'personne' => $personne,
